...
CREATE INDEX idx_refresh_watchers_status ON refresh_watchers(status);
CREATE INDEX idx_refresh_watchers_expires_at ON refresh_watchers(expires_at);
CREATE INDEX idx_refresh_watchers_xpub ON refresh_watchers(xpub_van);
